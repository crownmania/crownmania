...
app.use(helmet({
  ...
  contentSecurityPolicy: isProduction ? {
    directives: {
      ...
      connectSrc: ["'self'", "https://api.stripe.com", "https://api.web3auth.io", "https://*.firebaseio.com", "https://*.googleapis.com", "https://api.moralis.io", "wss://*.firebaseio.com"],
...
const getAllowedOrigins = () => {
  ...
  if (isProduction) {
    ...
    origins.push('https://crownmania.com', 'https://www.crownmania.com', 'https://api.crownmania.com');
  }
